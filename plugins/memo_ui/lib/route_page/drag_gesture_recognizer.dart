...
abstract class MDragGestureRecognizer extends OneSequenceGestureRecognizer {
  MDragGestureRecognizer({
    super.debugOwner,
...
class MVerticalDragGestureRecognizer extends MDragGestureRecognizer {
  MVerticalDragGestureRecognizer({
    super.debugOwner,
    super.supportedDevices,
  ...
  double scrollViewOffset = 0;

  @override
  bool _hasSufficientGlobalDistanceToAccept(
      PointerDeviceKind pointerDeviceKind, double? deviceTouchSlop) {
    return _globalDistanceMoved > 0 && scrollViewOffset == 0;
  }
...
class VerticalDragGestureRecognizerCache extends InheritedWidget {
  final MVerticalDragGestureRecognizer verticalDragGestureRecognizer;

  const VerticalDragGestureRecognizerCache(
      {super.key,
      required super.child,
      required this.verticalDragGestureRecognizer});

  @override
  bool updateShouldNotify(VerticalDragGestureRecognizerCache oldWidget) {
    return verticalDragGestureRecognizer !=
        oldWidget.verticalDragGestureRecognizer;
  }

  static VerticalDragGestureRecognizerCache? maybeOf(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<
        VerticalDragGestureRecognizerCache>();
  }
}
